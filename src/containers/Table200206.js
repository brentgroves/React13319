...
const mapDispatchToProps = dispatch => {
  ...
  Sproc200206Fetch: (sproc,table,limit,skip,route,setSubmittingOff) => dispatch(actions.Sproc200206Fetch(sproc,table,limit,skip,route,setSubmittingOff))
  }
}


export const Table200206 = connect(mapStateToProps, mapDispatchToProps)(Table200206Component)
